		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App para gerenciar ordens de venda",
									"targetURL": "#vicenterjgrandesprojetoszov-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vicenterjgrandesprojetoszov-display": {
								"semanticObject": "vicenterjgrandesprojetoszov",
								"action": "display",
								"description": "An SAP Fiori application - Ordens de Venda",
								"title": "App para gerenciar ordens de venda",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vicenterj.grandesprojetos.zov",
									"url": sap.ui.require.toUrl("vicenterj/grandesprojetos/zov")
								}
							}
						}
					}
